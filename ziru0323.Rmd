---
title: "ziru_resblock_renttype_meanprice_peraera"
author: "JK"
date: "2018年3月23日"
output: 
  html_document:
...
解决方法就是：在北京市范围内，以小区为统计单元，建立整租均价和合租均价的回归关系。实现二者的相互预测。</br>


##第一步：读入数据。
读入的数据的维数是：17202行    16列</br>
数据框ziru0的部分数据如下：</br>
```{r warning=FALSE}
